...
Security drift (also known as "security posture drift" or just "drift") occurs when your infrastructure becomes more vulnerable to attack. An organization's security practices and controls can deteriorate over time as system configurations or security measures deviate from established baselines. You can configure Mondoo to [automatically create a ticket](/platform/cases/manage/#automatically-create-cases-on-drift) in your tracking system (such as Jira or ServiceNow) when it detects drift.
