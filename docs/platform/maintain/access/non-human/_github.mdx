...
3. Select the **ADD PROVIDER** button or the plus (+) symbol near the top-right corner of the tab.
...
5. In the **Issuer URL** box, keep the default `https://token.actions.githubusercontent.com`.

6. In the **Subject** box, enter the organization and repository where you plan to create your GitHub Actions workflow.

7. In the **Expiration time** list, choose the duration of sessions authenticated with this WIF provider.

8. In the **Name** and **Description** boxes, provide a short name and longer description that help you and your teammates recognize the source and purpose of the workload identity provider.

9. Select the **ADD PROVIDER** button.
