...
If you choose to integrate an entire Organization, be sure your AWS Organization meets the requirements described in [AWS Integration Troubleshooting](/platform/infra/cloud/aws/lambda/aws-integration-troubleshooting/#requirements-for-deploying-the-mondoo-stackset-at-the-organization-level).
