...
Open the [cases management screen](https://console.mondoo.com/space/cases) on the Mondoo console to get started, or [check out the documentation](https://mondoo.com/docs/platform/maintain/jira/).
