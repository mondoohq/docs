...
8. Make sure the key type is set to **JSON**, then select **Create**. You see a message that the service account's private key JSON file was downloaded to your computer. Note the file name and where your browser saves it. You need it for later steps.
