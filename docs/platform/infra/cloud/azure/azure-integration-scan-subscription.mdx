...
The application certificate, that was created as part of adding the Azure integration, only has a limited lifetime (by default 1 year). When this certificate has expired the integration will no longer function.
