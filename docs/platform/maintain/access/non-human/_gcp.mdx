...
Open [Google Cloud Shell](https://cloud.google.com/shell/docs/launching-cloud-shell) and run this command:
...
#### Step C: Create a new workload identity provider in Mondoo
...
6. In the **Subject** box, enter the unique ID of the GCP service account you created in Step A.

7. In the **Expiration time** list, choose the duration of sessions authenticated with this WIF provider.

8. In the **Name** and **Description** boxes, provide a short name and longer description that help you and your teammates recognize the source and purpose of the provider.
...
#### Step D: Exchange your token for access to the Mondoo space
