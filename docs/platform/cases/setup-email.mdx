...
7. To automatically send an email message to one of these recipients every time Mondoo creates a new case based on drift, enable **Automatically send email for cases** and choose the recipient. To learn more about automatically creating cases on drift, read [Change Cases Settings](/platform/cases/manage/).
