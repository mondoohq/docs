---
title: Quick Setup - Azure Subscription Continuous Scanning - Step E
sidebar_label: Step E
sidebar_position: 6
description: Configure the Mondoo Azure integration to scan Azure subscriptions. Step E is to add the integration in Mondoo.
image: /img/featured_img/mondoo-azure.jpg
---

This is the final step in the quick setup for an Azure subscription.
