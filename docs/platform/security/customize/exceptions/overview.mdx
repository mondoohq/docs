...
- Exclude specific findings from impacting asset scores
- Scope security or compliance efforts to specific checks.
- Communicate false positives, workarounds, and other situations that necessitate ignoring a finding

Exceptions apply immediately, but they can be approved or rejected later. This allows you to track the status of exceptions along with the specific reason why they were created.
