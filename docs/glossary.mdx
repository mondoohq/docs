...
A Mondoo integration can also provide communication with a data [export destination](/platform/maintain/export/) or a [project management or ticket system](/platform/cases/overview/).
