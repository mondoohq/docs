...
[cnspec inventory templates](/cnspec/cnspec-adv-install/service/#cnspec-inventory-yml-template) let you re-use cnspec inventory files with custom variables. This is especially helpful in CI/CD pipelines.
