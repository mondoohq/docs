...
8. To create a case and a corresponding GitLab issue when an asset becomes more vulnerable to attack, enable **Create drift issues in this integration** and enter the GitLab project where you want to create new issues. To learn more, read [Automatically create cases on drift](/platform/cases/manage#automatically-create-cases-on-drift).
