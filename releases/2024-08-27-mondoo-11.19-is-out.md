...
Secure critical publically facing domains and IP addresses with the new Mondoo Shodan Security policy. This policy includes checks to identify open ports and vulerabilities as reported by the Shodan network scanning service.
...
- Mondoo Endpoint Detection and Response (EDR) policy now includes suppot for Cortex XDR
