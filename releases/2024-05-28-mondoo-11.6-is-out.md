...
Not sure where your IaC code lives? Now it doesn't matter with automatic Terraform plan file disovery in GitHub repositories. Scan your entire organization and Mondoo will do the heavy lifting to find and scan each file automatically.
