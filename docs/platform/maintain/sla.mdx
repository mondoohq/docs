...
Mondoo measures your team's security improvement performance against your service-level agreement (SLA). On your space dashboard, a chart compares your _committed_ time to remediate security findings against the _actual_ time.
...
3. For each risk score, type a number or use the arrows to define:
   ...
   - How many days after discovery do you want Mondoo to consider the SLA date _approaching_?
