---
title: Quick Setup - Azure Group Continuous Scanning - Step D
sidebar_label: Step D
sidebar_position: 5
description: Configure the Mondoo Azure integration to scan an Azure management group. Step D is to grant permissions to access Microsoft Graph (API permissions).
image: /img/featured_img/mondoo-azure.jpg
---

This is the fourth step in the quick setup for an Azure management group.
