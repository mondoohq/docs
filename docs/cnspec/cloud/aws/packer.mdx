...
Select any of the findings from your build to show additional supporting documentation as well as remediation steps:

![Findings details in a Mondoo scan result](/img/cnspec/aws/finding-details.png)
