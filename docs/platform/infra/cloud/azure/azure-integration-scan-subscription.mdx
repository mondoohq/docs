...
2. To automatically discover all Linux and Windows virtual machines (VMs) in your subscription and scan them using Azure Run Command, enable **Scan virtual machines**.
...
7. Paste the copied command in Azure Cloud Shell.

   ********* FOO BAR BAZ add stuff here to manage their expectations for what happens now **********
