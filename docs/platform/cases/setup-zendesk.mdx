...
10. To create a case and a corresponding Zendesk ticket when an asset becomes more exposed to attack, enable **Create drift issues in this integration**. To learn more, read [Automatically create cases on drift](/platform/cases/manage#automatically-create-cases-on-drift).
