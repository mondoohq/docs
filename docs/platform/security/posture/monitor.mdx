...
3. To view security for a space, select the box representing the space.
   ...
   The Space Dashboard shows:
      ...
      - An interactive circle chart of all the assets in the space

      - A list of the most important vulnerabilities to fix (based on risk and the number of affected assets)

      - A list of the most important security findings (such as configuration settings that put your organization at risk)

4. Use the interactive circle chart to explore the space:

   - The main, inside circle shows the distribution of types of assets in the space.

      ![Explore a space](/img/platform/security/fidget-hover.png)
   ...
   - The outer circle shows subsections of assets in the space.
      ...
      ![Explore a space](/img/platform/security/fidget-hover-2.png)

      Hover over a subsection to see the distribution of security scores in that subsection.

   - Select a section to zoom into the chart and see details of the section.
...
| Known [vulnerabilities](/platform/security/vuln/vulnerabilities/) discovered on the asset                                           | Vulnerabilities    |
| Publicly announced [advisories](/platform/security/vuln/advisories/) discovered on the asset                                   | Advisories         |
