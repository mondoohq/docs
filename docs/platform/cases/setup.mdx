...
10. To automatically create a corresponding Jira issue every time every time Mondoo creates a new case based on drift, enable **Automatically creates tickets for cases** and choose the destination Jira project for drift issues. To learn more about automatically creating cases on drift, read [Change Cases Settings](/platform/cases/manage/).
