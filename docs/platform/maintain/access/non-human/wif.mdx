...
Step 1. Gather the information you need from your WIF provider.

Step 2. Create an identity provider in Mondoo.

Step 3. Use the configuration information that Mondoo provides to authenticate your workload.


### Step 1: Gather information from your WIF provider
