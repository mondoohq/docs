...
#### Step 1: Prepare your GCP environment for WIF
...
#### Step 2: Retrieve credentials from GCP
...
#### Step 3: Create an identity provider in Mondoo
...
#### Step 4: Create a trust between Mondoo and GCP
...
| For...   | Substitute... |
| -------- | ------------- |
| AUDIENCE | The `audience` value Mondoo provided when you followed the instructions in **Step 3** above. |
| ISSUER   | The `issuer` value Mondoo provided when you followed the instructions in **Step 3** above.   |
| TOKEN    | The token GCP provided when you followed the the instructions in **Step 2** above              |
