---
title: Set Exceptions on Policies
sidebar_label: Set Exceptions on Policies
sidebar_position: 2
...
To temporarily exclude a check from your overall results, you can set it to _Risk Accepted_. While in this state, its failures don't affect your asset or space scores. Risk Acceptance is useful when you intend to comply with a guideline eventually but don't want it distracting your team right now.
...
1. In the [Mondoo Console](https://console.mondoo.com), [navigate](/platform/start/navigate/) to the space in which you want to set an exception.
