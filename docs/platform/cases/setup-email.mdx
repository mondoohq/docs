---
title: Set up Cases to Email Your Ticketing System
...
7. To send an email message to one of these recipients every time you create a new case in Mondoo, enable **Automatically send email for cases** and choose the default recipient. (Each time you create a case, you can choose a different recipient.)
