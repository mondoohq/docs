...
description: Announcing the 11.8 release of Mondoo, with fine grained asset scanning, software inventory, Snowflake scanning, and more!
author: Tim Smith
...
## 🥳 Mondoo 11.8 is out! This release includes fine grained asset scanning, software inventory, Snowflake scanning, and more!
...
Understand where critical security vulnerabilities exist within your infrastructure with fine-grained asset scanning. With checks applied directly to cloud assets, you can more easily see which assets are passing and which are failing without diving into complex account-wide check output.
...
To get started, click the "Software" button under Vulnerabilities in the main navigation. From there, you can access the full suite of features and begin improving your infrastructure's security posture immediately.

![Software list](/img/releases/2024-06-11-mondoo-11.8-is-out/software.png)
