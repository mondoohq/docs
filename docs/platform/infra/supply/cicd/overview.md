...
Instead of blocking the pipeline, you can choose to always pass the build if the scan was successful using the `--risk-threshold 100` flag.

```bash
cnspec scan docker a3592cc01fdf --risk-threshold 100
```
