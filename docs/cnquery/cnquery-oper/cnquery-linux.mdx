...
Mondoo makes these [core Linux query packs](https://github.com/mondoohq/cnquery) available in GitHub:

- [Linux Inventory Pack](https://github.com/mondoohq/cnquery/blob/main/content/mondoo-linux-inventory.mql.yaml) provides information about all your Linux assets and their configuration.
- [Linux Incident Response Pack](https://github.com/mondoohq/cnquery/blob/main/content/mondoo-linux-incident-response.mql.yaml) helps you investigate and minimize damage when a security incident occurs.

To run one of these purpose-built collections of Linux-specific queries:

1. In Mondoo's [cnquery GitHub repo](https://github.com/mondoohq/cnquery), go to the `content` directory and find the Linux query pack you want to run.
