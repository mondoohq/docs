...
The application certificate that was created as part of adding the Azure integration has a limited lifetime (by default 1 year). When this certificate expires the integration will no longer function.
