...
- For a list of all the operating system resources and fields you can query, read the [Network Devices MQL Resource Pack Reference](/mql/resources/networkdevices-pack/).
