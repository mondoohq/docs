...
8. To create a case and a corresponding GitHub issue when an asset becomes more vulnerable to attack, enable **Create drift issues in this integration** and enter the GitHub organization and repository where you want to create new issues. To learn more, read [Automatically create cases on drift](/platform/cases/manage#automatically-create-cases-on-drift).
