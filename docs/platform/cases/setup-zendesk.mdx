...
8. Select the **CREATE INTEGRATION** button.
   ...
   ![Configure cases in Mondoo](/img/platform/cases/add-zendesk-2.png)
...
11. To create a case and a corresponding Zendesk ticket when an asset becomes more exposed to attack, enable **Create drift issues in this integration**. To learn more, read [Automatically create cases on drift](/platform/cases/manage#automatically-create-cases-on-drift).
