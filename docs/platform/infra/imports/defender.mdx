...
## Add a new Microsoft Defender for Cloud integration in the Mondoo Console
...
Mondoo begins connecting to Microsoft Defender for Cloud and collecting data about your assets.
