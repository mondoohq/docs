...
10. Select the **Mappings** drop-down.

   ![Entra mappings](/img/platform/maintain/access/entra-scim/mappings.png)

11. Select **Provision Microsoft Entra ID Groups**.

12. Scroll down to the **Attribute Mappings** and make sure that these attributes are mapped:
