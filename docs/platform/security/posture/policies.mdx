...
2. Locate the policy you want to disable by scrolling through the list of available policies or using the **Filter policies** search box.

3. Check the box next to the policy (or policies) you want to remove and then select the **REMOVE POLICY** button.
