...
10. To create a case and a corresponding Jira issue when an asset becomes more vulnerable to attack, enable **Create drift issues in this integration** and choose the destination project. To learn more, read [Automatically create cases on drift](/platform/cases/manage#automatically-create-cases-on-drift).
