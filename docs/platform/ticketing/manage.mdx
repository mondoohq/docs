...
2. In the navigation sidebar, select **Settings** and then select the **Ticketing** tab.

3. Enable or disable **Automatically create tickets on drift**.
...
3. In the **Aggregation window** drop-down list, choose how long to wait to detect the same drift on other assets before finalizing a ticket and creating an issue/ticket in your ticket system.
