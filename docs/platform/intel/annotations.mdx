...
sidebar_position: 4
description: Add annotations, similar to tags, to the assets in your infrastructure using Mondoo
...
- The asset's inventory configuration file

- Programmatically using an inventory template
...
## Annotate an asset using a Mondoo inventory file


## Programmatically annotate assets using a Mondoo inventory template
