...
Organization audit logs are available via our GraphQL API.  To access the API, you must have created an [API token](/platform/maintain/access/api-tokens).
...
Please note that the GraphQL API URL for the EU region is https://eu.api.mondoo.com/query.
