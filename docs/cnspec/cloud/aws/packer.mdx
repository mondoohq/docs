...
- `score_threshold` - This configuration sets an `int` score threshold for security scans. If the scan produces a score that falls above the threshold, the build will fail.
...
==> cnspec-tested-amazon-ubuntu-2404-20251201234453.amazon-ebs.ubuntu2404: use OS provider version 11.4.69 (/Users/bboberson/.config/mondoo/providers/os)
