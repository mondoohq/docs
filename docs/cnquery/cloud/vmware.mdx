...
This query asks for the maximum number of failed login attempts before an EXSi user is locked out:
...
This query returns EXSi port group configuration data:
