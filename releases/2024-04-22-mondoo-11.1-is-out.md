...
Expose security concerns before they reach production with new Mondoo scanning of Dockerfiles. Run `cnquery shell docker file DIRECTORY_OR_PATH` to inspect a single Dockerfile or find nested Dockerfiles within directories. Using the new `docker.file` resource you can explore the file itself or dive into Dockerfile stages and instructions.
...
- Improve performance scanning instance
