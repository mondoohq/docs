...
- The **Policies** tab lists all the policies that contain the checks this framework maps to. You can enable, disable or set policies to preview.
...
6. Select the **VIEW REPORTS** button to go to the Reporting page where you can download the report. It can take some time for Mondoo to generate a PDF with all the requested compliance data. If the new report is still in progress, you can leave and return to the Reporting page later to retrieve it.

   ![Mondoo compliance reports](/img/platform/compliance/reporting-page.png)

7. To download a report, select the download icon (the down arrow) on the report's row.
...
3. Hover over the report you wish to delete and select the trash can icon.

   ![Delete a Mondoo compliance report](/img/platform/compliance/delete-report.png)
