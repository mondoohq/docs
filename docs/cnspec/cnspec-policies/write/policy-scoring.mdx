...
| :--------------------- | :----------------------- | :------------------------------------ |
| Pass (100)             | Pass (100)               | (100 + 100) / 2 = **100** or **None** |
| Pass (100)             | Fail (100 - 80 = 20)     | (100 + 20) / 2 = **60** or **Medium** |
| Fail (100 - 90 = 10)   | Pass (100)               | (10 + 100) / 2 = **55** or **Medium** |
| Fail (100 - 90 = 10)   | Fail (100 - 80 = 20)     | (10 + 20) / 2 = **15** or **High**    |
