...
7. In the **Tenant URL** box, enter your SCIM base URL.

8. In the **Secret Token** box, paste your Mondoo API token.
...
### Step E: Provision users in Entra
...
- To learn more about applications in Entra, read [Build Flows](https://help.okta.com/wf/en-us/content/topics/workflows/build/build-flows.htm).
